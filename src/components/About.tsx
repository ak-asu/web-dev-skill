...
const About: React.FC = () => {
  return (
    <section id="about" className="py-20 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-10 items-center">
            ...
            <div className="md:w-2/3">
              {/* First paragraph - Professional summary */}              <p className="text-lg mb-6 leading-relaxed text-gray-700 dark:text-gray-300">
              ...
              {/* Info badges - Location and availability */}              <div className="flex flex-wrap gap-3">
                {/* Location badge */}
